...
const colors = {
    ...
    layout: {
        general: {
            bodyBg: '#F6F8FB',
            disabledCardBackground: alpha('#E8EAED', 0.55),
        },
        sidebar: {
            background: '#BCC5CA',
...
const theme = createTheme({
    ...
    palette: {
        ...
        background: {
            ...
            disabledCardBackground: colors.layout.general.disabledCardBackground,
        },
        action: {
        ...
        MuiListItem: {
            styleOverrides: {
                button: {
                    ...
                    '&:hover, &:active, &.active, &.Mui-selected': {
                        color: colors.alpha.black[100],
                        background: lighten(colors.primary.main, 0.5),
                    },
                },
            },
        },
