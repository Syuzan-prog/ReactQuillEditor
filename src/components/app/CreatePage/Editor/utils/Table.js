...
import ReactQuill, { Transforms, Range, Element } from 'react-quill';
...
export class TableUtil {
  ...
  insertTable = (rows, columns) => {
      const [tableNode] = ReactQuill.nodes(this.editor, {
          match: (n) =>
              !ReactQuill.isEditor(n) && Element.isElement(n) && n.type === 'table',
          mode: 'highest',
      });
